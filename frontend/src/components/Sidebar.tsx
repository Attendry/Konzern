...
const Icons = {
  ...
  currency: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M15 9.5a3 3 0 1 0 0 5H9a3 3 0 1 1 0-5" />
    </svg>
  ),
  document: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
interface SidebarProps {
  /** Callback when the collapsed state changes, used by parent to apply layout class */
...
export function Sidebar({ onCollapsedChange }: SidebarProps) {
  ...
  useEffect(() => {
    onCollapsedChange?.(isVisuallyCollapsed);
  }, [isVisuallyCollapsed, onCollapsedChange]);
